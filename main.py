...
from core.handlers.payment_callback import (
    buying_course_handler,
    check_payment_handler,
    choice_course_buts_handler,
    confirm_course_selection_handler,
)
...
from core.handlers.support import (
    admin_answer_to_user,
    waiting_message_from_user_handler,
    question_but_handler,
)
from core.handlers.callback import (
    back_to_menu_button_handler,
    check_registration_handler,
    first_course_handler,
    get_info_handler,
    test_handler,
)
from core.handlers.registrationForm import (
    handler_accept_but,
    handler_back_but,
    handler_user_reg_data,
    registration_but_handler,
)
...
async def start() -> None:
    ...
    dp.callback_query.register(
        admin_answer_but_handler, F.data.startswith("admin_take_question")
    )
    ...
    dp.callback_query.register(
        get_promocodes, F.data.startswith("getpromo_"), IsAdmin()
    )
    ...
    dp.callback_query.register(
        confirm_course_selection_handler, F.data.startswith("pay")
    )
